...
- **Rotate the Supabase service-role key.** It sat in plaintext node code across 7.1, 7.4, 7.6 and 7.7.
- 7.6b has not been run end to end; it needs a real `strategy_page_id`.
- 7.5 still chains to 7.6, not 7.6b. Repoint after the first successful run.
